...
@Composable
fun SearchIcon() = SearchVectorIcon(24.dp, MaterialTheme.colorScheme.onSurfaceVariant)
...
@Composable
fun ChevronIcon() = ChevronVectorIcon(20.dp, MaterialTheme.colorScheme.outline)
...
@Composable
fun DragIcon() = DragVectorIcon(16.dp, MaterialTheme.colorScheme.outline)
...
@Composable
fun SettingsIcon() = SettingsVectorIcon(24.dp, MaterialTheme.colorScheme.onSurfaceVariant)
...
@Composable
fun SearchOffIcon(iconSize: Dp, color: Color) = VectorIcon(iconSize) { scale ->
    drawCircle(color, 6f * scale, Offset(10f * scale, 10f * scale), style = Stroke(1.7f * scale))
    drawLine(
        color,
        Offset(14.5f * scale, 14.5f * scale),
...
@Composable
fun StarIcon(on: Boolean, size: Dp = 24.dp, colorOverride: Color? = null) {
