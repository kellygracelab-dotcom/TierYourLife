...
@Composable
fun PersonIcon(iconSize: Dp, color: Color) = VectorIcon(iconSize) { scale ->
...
@Composable
fun HideIcon(iconSize: Dp, color: Color) = VectorIcon(iconSize) { scale ->
    val stroke = Stroke(STROKE * scale, cap = StrokeCap.Round)
    val lens = Path().apply {
...
@Composable
fun FlagIcon(iconSize: Dp, color: Color) = VectorIcon(iconSize, autoMirror = true) { scale ->
    val stroke = Stroke(STROKE * scale, cap = StrokeCap.Round)
    drawLine(
        color,
