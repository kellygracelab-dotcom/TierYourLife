...
@Composable
fun PlusIcon(iconSize: Dp, color: Color) = VectorIcon(iconSize) { scale ->
    drawLine(
        color,
...
@Composable
fun DeleteSweepIcon(iconSize: Dp, color: Color) = VectorIcon(iconSize, autoMirror = true) { scale ->
...
@Composable
fun RestoreIcon(iconSize: Dp, color: Color) = VectorIcon(iconSize, autoMirror = true) { scale ->
...
@Composable
fun DeleteIcon(iconSize: Dp, color: Color) = VectorIcon(iconSize) { scale ->
    val stroke = 1.8f * scale
