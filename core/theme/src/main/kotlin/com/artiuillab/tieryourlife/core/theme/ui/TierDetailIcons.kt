...
@Composable
fun SouthIcon(iconSize: Dp, color: Color) = VectorIcon(iconSize) { scale ->
...
@Composable
fun DeleteFilledIcon(iconSize: Dp, color: Color) = VectorIcon(iconSize) { scale ->
...
@Composable
fun CategoryIcon(iconSize: Dp, color: Color) = VectorIcon(iconSize) { scale ->
    val stroke = 1.7f * scale
...
@Composable
fun TuneIcon(iconSize: Dp, color: Color) = VectorIcon(iconSize, autoMirror = true) { scale ->
...
@Composable
fun ContrastIcon(iconSize: Dp, color: Color) = VectorIcon(iconSize) { scale ->
    drawArc(
        color,
        startAngle = -90f,
        sweepAngle = 180f,
...
@Composable
fun GridViewIcon(iconSize: Dp, color: Color) = VectorIcon(iconSize) { scale ->
...
@Composable
fun ViewCarouselIcon(iconSize: Dp, color: Color) = VectorIcon(iconSize) { scale ->
...
@Composable
fun FormatListNumberedIcon(iconSize: Dp, color: Color) = VectorIcon(iconSize, autoMirror = true) { scale ->
    val stroke = 1.6f * scale
    repeat(3) { row ->
...
@Composable
fun ExpandLessIcon(iconSize: Dp, color: Color) = VectorIcon(iconSize) { scale ->
    val stroke = 1.7f * scale
...
@Composable
fun ImagePlaceholderIcon(iconSize: Dp, color: Color) = VectorIcon(iconSize) { scale ->
...
@Composable
fun PhotoLibraryIcon(iconSize: Dp, color: Color) = VectorIcon(iconSize, autoMirror = true) { scale ->
...
@Composable
fun AutoAwesomeIcon(iconSize: Dp, color: Color) = VectorIcon(iconSize) { scale ->
...
@Composable
fun ShareIcon(iconSize: Dp, color: Color) = VectorIcon(iconSize) { scale ->
    val stroke = 1.8f * scale
