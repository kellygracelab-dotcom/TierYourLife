...
internal object AccountTestTags {
    ...
    const val MERGE = "account_merge"
    const val MERGE_KEEP_EVERYTHING = "account_merge_keep_everything"
    const val MERGE_ACCOUNT_ONLY = "account_merge_account_only"
    const val MERGE_CONTINUE = "account_merge_continue"
    const val DONE = "account_done"
    const val SIGN_OUT = "account_sign_out"
    const val DELETE_ACCOUNT = "account_delete"
    const val DELETE_CONFIRM = "account_delete_confirm"
    const val DELETE_DIALOG = "account_delete_dialog"
